...
![createProject_2](./figures/createProject_2.png)
...
在 VSCode 中使用快捷键 F1，或同时按下 Ctrl + Shift + P（macOS 系统为 Command + Shift + P）打开命令面板，按照以下步骤创建仓颉文件。

**第一步：选择创建仓颉文件命令**

![createFile_1](./figures/createFile_1.png)

**第二步：选择文件路径**

![createFile_2](./figures/createFile_2.png)

**第三步：输入文件名称**

![createFile_3](./figures/createFile_3.png)

**第四步：完成创建并打开**

![createFile_4](./figures/createFile_4.png)

## 使用右键单击创建

在 VSCode 中使用右键单击按照以下步骤创建仓颉文件。

**第一步：右键单击仓颉文件夹，选择 New File...**

![createNewFile_1](./figures/createNewFile_1.png)

**第二步：输入完整的仓颉文件名称**

![createNewFile_2](./figures/createNewFile_2.png)

**第三步：完成创建并打开**

![createNewFile_3](./figures/createNewFile_3.png)
